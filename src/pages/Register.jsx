            ...
            <div style={{ width: '100%', maxWidth: '400px' }}>
                ...
                <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.5)', border: '1px solid #334155', borderRadius: '16px', padding: '32px' }}>
                        ...
                        <div style={{ marginBottom: '16px' }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                <input
                                    ...
                                    style={{ width: '100%', backgroundColor: '#0f172a', border: '1px solid #334155', borderRadius: '8px', padding: '12px 12px 12px 44px', color: '#f8fafc', fontSize: '16px' }}
                    ...
                    <p style={{ textAlign: 'center', color: '#94a3b8', marginTop: '24px' }}>
                        Masz już konto? <Link to="/login" style={{ color: '#0ea5e9' }}>Zaloguj się</Link>
                    </p>
                </div>
            </div>
        </div>
