...
import { 
    ...
    LogOut, Loader2, BarChart3, Shield, User, Wallet, Globe
} from 'lucide-react';
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '64px' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                            <div style={{ textAlign: 'right' }}>
                                ...
                                <p style={{ fontWeight: '600', color: '#0ea5e9', margin: 0 }}>${user?.balance?.toFixed(4) || '0.0000'}</p>
                            </div>
                            {user?.isAdmin && (
                                <Link
                                    to="/admin"
            ...
            <main style={{ maxWidth: '1200px', margin: '0 auto', padding: '32px 16px' }}>
                ...
                <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.5)', border: '1px solid #334155', borderRadius: '12px' }}>
                    <div style={{ padding: '24px', borderBottom: '1px solid #334155', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <h2 style={{ fontSize: '20px', fontWeight: '600', margin: 0 }}>Twoje linki</h2>
                        <button
                                ...
                                <div key={link.id} style={{ padding: '16px 24px', borderBottom: '1px solid #1e293b' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px', flexWrap: 'wrap' }}>
                                        <div style={{ flex: 1, minWidth: '200px' }}>
                                            ...
                                            <p style={{ fontSize: '14px', color: '#94a3b8', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', margin: '4px 0' }}>
                                                {link.originalUrl}
                                            </p>
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
                                            <div style={{ textAlign: 'center' }}>
                                                <p style={{ fontSize: '14px', color: '#94a3b8', margin: 0 }}>Kliknięcia</p>
                                                <p style={{ fontWeight: '600', margin: 0 }}>{link.totalClicks}</p>
                                            </div>
                                            <div style={{ textAlign: 'center' }}>
                                                <p style={{ fontSize: '14px', color: '#94a3b8', margin: 0 }}>Zarobione</p>
                                                <p style={{ fontWeight: '600', color: '#22c55e', margin: 0 }}>
